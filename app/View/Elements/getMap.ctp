...
echo $this->GoogleMapV3->map(array('div'=>array('height'=>'400', 'width'=>'100%')));
    ...
    // debug($result);
			...
			$this->GoogleMapV3->addMarker(array('lat'=>$result['geocodes']['lat'],'lng'=>$result['geocodes']['lng'], 'title'=>'Marker',           'content'=>'<a href="/"/>the deaf institute</a>', 'icon'=>$this->GoogleMapV3->iconSet('green', 'E')));
	}
