<?php $this->set('title_for_layout', 'Venue | '.$venueDetails['name']) ?>
<div class="row">
	<?php $this->set('profileId', $venueDetails['user_id'])?>
	<div class="span2">
		<div class="profilePicture"><img src="<?php echo $venueDetails['profile_picture'] ?>" /></div>
		<div class="profileMenu">
			<ul class="nav nav-list">
				...
				<li><a><i class="icon-calendar"></i> Events</a></li>
				<li class="divider"></li>
	...
	<div class="span10">
		...
		<h3><?php echo $venueDetails['name']; ?></h3>
		</div>
		<div class="buttons" style="float: right;">
		<?php if($venueDetails['user_id'] == $this->Session->read('User.id')) 
		      {
		      	echo "That's you";
		      }
		      elseif (!$areConnected)
		      {
		      	echo '<a href="'.$this->webroot.'Connections/requestConnection/'.$venueDetails["user_id"].'"class="btn">Connect</a>'; 
		      }	
		...
		<div class="profileInfo">
			<span><small>1 Location : <?php echo $venueDetails['location'] ?> 2 Popularity/rating 3 Genre</small></span>
		</div>
